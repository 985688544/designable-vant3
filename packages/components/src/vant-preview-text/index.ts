...
import { VantSpace } from '../vant-space'
import {
  Switch as VanSwitch,
  Rate as VanRate,
...
const prefixCls = `${vantStylePrefix}-preview-text`
const PlaceholderContext = createContext('N/A')

export const vantUsePlaceholder = (value?: Ref<any>) => {
...
const VantInput = observer(
  defineComponent({
    ...
    setup(props, { attrs, slots }) {
      ...
      const placeholder = vantUsePlaceholder(value)
      return () => {
        return h(
          'div',
          {
            class: [prefixCls, `${vantStylePrefix}-preview-input`],
            style: attrs.style,
            attrs: {
              ...attrs,
              ...props,
  ...
  defineComponent({
    ...
    setup(_props, { attrs }) {
      ...
      const dataSource: any[] = field?.dataSource?.length
        ...
        ? props.options
        : []
      const placeholder = vantUsePlaceholder()
      const getSelected = () => {
...
export const VantPreviewText = composeExport(Text, {
  VantInput,
  Checkbox,
  Switch,
  Stepper,
...
export default VantPreviewText
