...
export interface VantFormProps extends FormLayoutProps {
  form?: FormType
  component?: Component
...
export const VantForm = defineComponent({
  name: 'FForm',
  props: [
    'form',
    'component',
  ...
  setup(props: VantFormProps, { attrs, slots }: SetupContext) {
    const top = useForm()
